...
#ifndef jit_ppc_Bailouts_ppc_h
#define jit_ppc_Bailouts_ppc_h
...
class BailoutStack
{
    ...
    // handler insert their own value into LR, which is then placed onto the
    // stack along with frameClassId_ above.
  public:
    union {
