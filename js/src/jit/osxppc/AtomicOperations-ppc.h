...
#ifndef jit_ppc_shared_AtomicOperations_ppc_shared_h
#define jit_ppc_shared_AtomicOperations_ppc_shared_h
...
#endif // jit_ppc_shared_AtomicOperations_ppc_shared_h
