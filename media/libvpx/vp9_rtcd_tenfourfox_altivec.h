...
void vp9_convolve_avg_vmx(const uint8_t *src, ptrdiff_t src_stride, uint8_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int x_step_q4, const int16_t *filter_y, int y_step_q4, int w, int h);
#define vp9_convolve_avg vp9_convolve_avg_vmx
...
void vp9_convolve_copy_vmx(const uint8_t *src, ptrdiff_t src_stride, uint8_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int x_step_q4, const int16_t *filter_y, int y_step_q4, int w, int h);
#define vp9_convolve_copy vp9_convolve_copy_vmx
...
void vp9_idct16x16_10_add_vmx(const int16_t *input, uint8_t *dest, int stride);
#define vp9_idct16x16_10_add vp9_idct16x16_10_add_vmx
...
#define vp9_idct16x16_1_add vp9_idct16x16_1_add_vmx

void vp9_idct16x16_256_add_c(const tran_low_t *input, uint8_t *dest, int dest_stride);
void vp9_idct16x16_256_add_vmx(const int16_t *input, uint8_t *dest, int stride);
#define vp9_idct16x16_256_add vp9_idct16x16_256_add_vmx

void vp9_idct32x32_1024_add_c(const tran_low_t *input, uint8_t *dest, int dest_stride);
void vp9_idct32x32_1024_add_vmx(const int16_t *input, uint8_t *dest, int stride);
#define vp9_idct32x32_1024_add vp9_idct32x32_1024_add_vmx
...
#define vp9_idct32x32_1_add vp9_idct32x32_1_add_vmx

void vp9_idct32x32_34_add_c(const tran_low_t *input, uint8_t *dest, int dest_stride);
void vp9_idct32x32_34_add_vmx(const int16_t *input, uint8_t *dest, int stride);
#define vp9_idct32x32_34_add vp9_idct32x32_34_add_vmx
...
#define vp9_idct4x4_16_add vp9_idct4x4_16_add_vmx
...
#define vp9_idct4x4_1_add vp9_idct4x4_1_add_vmx
...
#define vp9_idct8x8_12_add vp9_idct8x8_12_add_vmx
...
#define vp9_idct8x8_1_add vp9_idct8x8_1_add_vmx
...
#define vp9_idct8x8_64_add vp9_idct8x8_64_add_vmx

void vp9_iht16x16_256_add_c(const tran_low_t *input, uint8_t *output, int pitch, int tx_type);
void vp9_iht16x16_256_add_vmx(const int16_t *input, uint8_t *dest, int stride, int tx_type);
#define vp9_iht16x16_256_add vp9_iht16x16_256_add_vmx
...
#define vp9_iht4x4_16_add vp9_iht4x4_16_add_vmx

void vp9_iht8x8_64_add_c(const tran_low_t *input, uint8_t *dest, int dest_stride, int tx_type);
void vp9_iht8x8_64_add_vmx(const int16_t *input, uint8_t *dest, int stride, int tx_type);
#define vp9_iht8x8_64_add vp9_iht8x8_64_add_vmx
